...
const offices = [
    { id: 1, city: 'Kano Nigeria', address: ['4556 Audu Bako Way', 'Kano, CA 90210'] },
    { id: 2, city: 'Abuja Nigeria', address: ['886 Walter Streets', 'New York, NY 12345'] },
    { id: 3, city: 'Lagos Nigeria', address: ['7363 Cynthia Pass', 'Toronto, ON N3Y 4H8'] },
    { id: 4, city: 'Kaduna Nigeria', address: ['114 Cobble Lane', 'London N1 2EF'] }
]
...
export default function Contact() {
    return (
        ...
        <div aria-labelledby="offices-heading">
